 ...
 * are persisted to the Write-Ahead Log (EVENT, VECSET, METASET). The codec is
 ...
 * metadata handler and re-parse it identically.
 */
 ...
 * otherwise kEventAdd. VECSET maps to kVecSet, METASET maps to kMetaSet.
 *
 * @param cmd Command to classify (must be EVENT, VECSET, or METASET)
 ...
 *
 * Only EVENT, VECSET, and METASET commands are encodable. For any other command
 ...
 * dimension; METASET records populate filter_expr.
 *
