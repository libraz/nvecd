/**
 * @file error.h
 * @brief Common error types and error codes for nvecd
 *
 * Reference: ../mygram-db/src/utils/error.h
 * Reusability: 90% (adjusted error code ranges for nvecd)
 *
...
/**
 * @brief Error codes for all nvecd modules
 *
...
enum class ErrorCode : std::uint16_t {
  ...
  // ===== Event Processing Errors (2000-2999) =====
  kEventStoreError = 2000,         ///< General event store error
  kEventCtxBufferFull = 2001,      ///< Context buffer full
  kEventInvalidScore = 2002,       ///< Invalid score value
  kEventCtxNotFound = 2003,        ///< Context not found
  kEventDecayFailed = 2004,        ///< Event decay operation failed
  ...
  kSnapshotSaveFailed = 5013,          ///< Failed to save snapshot
...
inline const char* ErrorCodeToString(ErrorCode code) {
  switch (code) {
    ...
    // Event Processing
    case ErrorCode::kEventStoreError:
      return "Event store error";
    case ErrorCode::kEventCtxBufferFull:
      return "Context buffer full";
    case ErrorCode::kEventInvalidScore:
      return "Invalid score value";
    case ErrorCode::kEventCtxNotFound:
      return "Context not found";
    case ErrorCode::kEventDecayFailed:
      return "Event decay failed";
    case ErrorCode::kEventCoOccurrenceError:
      return "Co-occurrence error";

    // Command Parsing
    case ErrorCode::kCommandSyntaxError:
      return "Command syntax error";
    case ErrorCode::kCommandInvalidToken:
      return "Invalid token";
    case ErrorCode::kCommandUnexpectedToken:
      return "Unexpected token";
    case ErrorCode::kCommandMissingArgument:
      return "Missing argument";
    case ErrorCode::kCommandInvalidArgument:
      return "Invalid argument";
    case ErrorCode::kCommandTooLong:
      return "Command too long";
    case ErrorCode::kCommandUnknown:
      return "Unknown command";
    case ErrorCode::kCommandInvalidTopK:
      return "Invalid top_k";
    case ErrorCode::kCommandInvalidMode:
      return "Invalid mode";
    case ErrorCode::kCommandInvalidVector:
      return "Invalid vector";
    case ErrorCode::kCommandParseError:
      return "Command parse error";

    // Vector/Similarity
    case ErrorCode::kVectorDimensionMismatch:
      return "Vector dimension mismatch";
    case ErrorCode::kVectorNotFound:
      return "Vector not found";
    case ErrorCode::kVectorInvalidDimension:
      return "Invalid vector dimension";
    case ErrorCode::kVectorStoreFull:
      return "Vector store full";
    case ErrorCode::kVectorStoreError:
      return "Vector store error";
    case ErrorCode::kSimilaritySearchFailed:
      return "Similarity search failed";
    case ErrorCode::kSimilarityInvalidMode:
      return "Invalid similarity mode";
    case ErrorCode::kSimilarityNoResults:
      return "No similarity results";
    case ErrorCode::kSimilarityComputeError:
      return "Similarity compute error";
    ...
    case ErrorCode::kStorageDumpReadError:
      return "Dump read error";
    case ErrorCode::kStorageDumpWriteError:
      return "Dump write error";
    case ErrorCode::kSnapshotSaveFailed:
      return "Snapshot save failed";
    case ErrorCode::kSnapshotLoadFailed:
      return "Snapshot load failed";
    case ErrorCode::kSnapshotVerifyFailed:
...
/**
 * @brief Base error class for all nvecd errors
 *
...
#define NVECD_ERROR(code, message) \
  nvecd::utils::MakeError(code, message, std::string(__FILE__) + ":" + std::to_string(__LINE__))
